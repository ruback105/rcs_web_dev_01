...
const validationRules = {
    ...
    password: {
        ...
        customValidate: (passwordValue) => {
            ...
            return {
                message: "Password should include at least 1 lowercase letter, 1 uppercase letter, 1 number and 1 special character(@$!%*?&)",
                valid: isValid,
            };
        },
    },
    ...
    form.addEventListener("submit", (evt) => {
        ...
        inputFields.forEach((input) => {
            ...
            if (inputValidation.minLength &&
                ...
                displayError(`This should be at least ${inputValidation.minLength} characters long`, input);
                return;
            }
